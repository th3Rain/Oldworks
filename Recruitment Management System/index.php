...
<head>
    ...
    <title>R.M.S job &amp; solution</title>
                    ...
                    <div class="row-fluid">
                        <div class="span7">
                            ...
                            <a class="brand" href="index.php" title="Home">
                                <h1>
                                    <img src="Content/img/rms_logo.png" />
                                </h1>
                            </a>
                ...
                <div class="navbar-inner">
                    ...
                    <!--user menu-->
                      <ul class="nav user-menu pull-right">
                            <li><a href="candidate/register.php" class="btn btn-success signup">Register</a></li>
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu" role="menu" aria-labelledby="login-drop">
                                    <form action="candidate/loginProcessing.php" method="POST" class="form-inline" id="login-form-drop" role="menuitem">
                                    ...
                                    <span class="divider" role="menuitem"></span><small role="menuitem">Not yet registered? <a href="candidate/register.php" class="signup">Register now!</a></small> <small role="menuitem"><a href="candidate/recover.php">Forgotten password?</a></small>
                                </div>
                            </li>
                    </ul>
...
<div class="row-fluid" style="text-align: center;">
    <img src="Content/img/nationally.jpg" />

</div>

<div class="row-fluid">
    <h2 class="title-divider" style="margin-bottom: 5px;"><span>Recruitment / Placement / Online Exams</span> </h2>
    <small class="lead" style="display: block; color: rgba(51, 51, 51, 0.60);">International Recruitment management System.</small>


    <ul class="nav nav-tabs hidden-phone" id="quicksand-categories">
        <li class="active"><a href="#" class="all">All Available Jobs</a></li>
        <li><a href="#" class="type-scholarship">Undergraduate</a></li>
        <li><a href="#" class="type-bursary">B.Sc</a></li>
        <li><a href="#" class="type-grant">M.sc & Phd</a></li>
    </ul>
</div>
...
<div class="row-fluid" style="margin-left: 0;">
    ...
    <ul class="thumbnails block customers span12" id="quicksand">
</ul>
